...
public class QProduct extends EntityPathBase<Product> {
    ...
    private static final long serialVersionUID = -1634454009L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QProduct product = new QProduct("product");

    public final com.sparta.camp.java.FinalProject.domain.category.entity.QCategory category;
    ...
    public QProduct(Class<? extends Product> type, PathMetadata metadata, PathInits inits) {
        ...
        this.category = inits.isInitialized("category") ? new com.sparta.camp.java.FinalProject.domain.category.entity.QCategory(forProperty("category"), inits.get("category")) : null;
